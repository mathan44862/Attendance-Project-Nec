...
@WebServlet("/showabsent")

public class Showabsent extends HttpServlet{
    public void doGet(HttpServletRequest req,HttpServletResponse res)  throws ServletException,IOException  
    {
        ...
        try{  
            ...
            ResultSet rs=stmt.executeQuery("select * from staff_leave");  
            while(rs.next()){
            ...
            req.getRequestDispatcher("AbsentList1.jsp").forward(req, res); 
        }
        catch(Exception e){
